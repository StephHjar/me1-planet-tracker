# Generated by Django 3.2.16 on 2022-11-26 15:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='planet',
            name='turian_insignia',
            field=models.BooleanField(default=False),
        ),
        migrations.AddField(
            model_name='planet',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='planets', to=settings.AUTH_USER_MODEL),
        ),
    ]
